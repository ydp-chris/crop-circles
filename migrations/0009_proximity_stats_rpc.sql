-- ============================================================================
-- Migration: 0009_proximity_stats_rpc.sql
-- Purpose:   Deterministic proximity comparison for the public /findings page.
--            Compares formation-to-heritage-site distances against a random
--            baseline of points in the same Wessex bbox. Fixed RNG seed for
--            reproducibility across callers.
-- ============================================================================
...
grant execute on function crop_circles.cc_proximity_stats(integer)
